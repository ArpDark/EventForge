...
function Login(){
  ...
  return(
    <div className='flex flex-col h-screen w-screen  border-2 border-green-300 items-center bg-cyan-50 '>
      ...
      <form action="/Login" method="" className='grid gap-4 pt-4 mt-10 w-1/2 md:w-1/4 bg-white shadow-md rounded px-8'>
        ...
        <button className='flex justify-center place-self-center w-3/4 md:w-1/2 bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow mt-4 mb-4' type="submit" onClick={handleSubmit}>Login</button>
      </form>
    </div>
  );
}
